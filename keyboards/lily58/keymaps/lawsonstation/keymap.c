 ...
 */
  [_ADJUST] = LAYOUT(
  XXXXXXX, QWERTY,  COLEMAK, QWERTY2, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
const char *read_layer_state(void);  // Used for current layer
const char *read_default_layer_state(void);  // Use for default layer
